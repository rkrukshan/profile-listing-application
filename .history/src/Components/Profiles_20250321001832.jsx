        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            (
                <div key={profile.client_id} className='border p-4 rounded shadow'>
                    ...
                    <h2 className="text-lg font-bold mt-2"><span>Name</span> {profile.client_name}</h2>
                    <h2 className="text-lg font-bold mt-2"><span>Location</span> {profile.client_city}</h2>
