    ...
    return (
        <div className="container mx-auto p-4 my-5">
            <input
                ...
                className="w-full ring-1 ring-gray-300 p-2 border rounded my-6 text-slate-800 text-center font-bold focus:ring-2 focus:ring-blue-500 outline-none"
                value={search}
                onChange={(e) => {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-11">
