                ...
                {currentProfiles.length > 0 ? (
                    currentProfiles.map((profile) => (
                        <div key={profile.client_id} className="border p-4 rounded shadow">
                            ...
                            />
                            <h2 className="flex justify-between px-5 text-lg font-semibold mt-2">
                                <span className='text-gray-600'>Name-</span>
                                <span className="text-blue-600 font-semibold">{profile.client_name}</span>
                            </h2>

                            <h2 className="flex justify-between px-9 text-lg font-semibold mt-2">
                            ...
                            <Link
                                ...
                                className="block mt-2 text-blue-800 text-center">View Details
                            </Link>
                        </div>
                    ))
                ) : (
