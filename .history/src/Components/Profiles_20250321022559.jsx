    ...
    return (
        <div className="container mx-auto p-4">
            <input
                ...
                className="w-full ring-1 ring-slate-200 p-2 border rounded my-29 text-center font-bold"
                value={search}
                onChange={(e) => {
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-25 gap-4">
